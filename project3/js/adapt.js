 ...
 */       /* location.href="sth.html"; */
            ...
            finish.addEventListener('click',function (){
                ...
                //     console.log()
                // }
                location.href='/html/transposemain.html';          
...
for (let i = 0; i < 4; i++) {
    ...
    let clickable = document.getElementsByClassName("label");
    let listElems = document.getElementsByTagName("li");
    listElems[i].style.position="relative";

    clickable[i].style.position="absolute";
    clickable[i].style.width="100%";
    clickable[i].style.height="100%";
    clickable[i].style.top="0";
    clickable[i].style.display="grid";
    clickable[i].style.alignItems="center";
    clickable[i].style.left="50px";
  }
